...
public class SellerListController implements Initializable, DataUpdateListener {
	...
	public void updateTableView() {
		...
		List<Seller> depList = service.findAll();
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		 ...
		 * controller.subscribeDataUpdateListener(this); controller.updateFormData();
		 * 
	...
	private void removeEntity(Seller obj) {
		Optional<ButtonType> result = Alerts.showConfirmation("Delete confirmation",
